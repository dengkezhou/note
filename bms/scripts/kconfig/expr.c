...
static void expr_extract_eq(enum expr_type type, struct expr **ep,
...
static inline struct expr *expr_get_leftmost_symbol(const struct expr *e) {
...
struct expr *expr_simplify_unmet_dep(struct expr *e1, struct expr *e2) {
  ...
  switch (e1->type) {
  case E_OR:
    return expr_alloc_and(expr_simplify_unmet_dep(e1->left.expr, e2),

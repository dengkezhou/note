...
#define DMAC_COMMON_INTSTATUS_ENA                                              \
  (DMA_BASEADDR + 0x040) /* R DMAC Interrupt Status Enable */
#define DMAC_COMMON_INTSIGNAL_ENA                                              \
  (DMA_BASEADDR + 0x048) /* R/W DMAC Interrupt Signal Enable */
#define DMAC_COMMON_INTSTATUS                                                  \
  (DMA_BASEADDR + 0x050)                  /* R DMAC Interrupt Status */
...
#define CH_BLOCK_TS                                                            \
  (DMA_CH0_BASEADDR + 0x010)                  /* R/W Chan Block Transfer Size */
...
#define CH_SWHSSRC (DMA_CH0_BASEADDR + 0x038) /* R/W Chan SW Handshake Source  \
                                               */
#define CH_SWHSDST                                                             \
  (DMA_CH0_BASEADDR + 0x040) /* R/W Chan SW Handshake Destination */
#define CH_BLK_TFR_RESUMEREQ                                                   \
  (DMA_CH0_BASEADDR + 0x048) /* W Chan Block Transfer Resume Req */
...
#define CH_SSTATAR                                                             \
  (DMA_CH0_BASEADDR + 0x070) /* R/W Chan Source Status Fetch Addr */
#define CH_DSTATAR                                                             \
  (DMA_CH0_BASEADDR + 0x078) /* R/W Chan Destination Status Fetch Addr */
#define CH_INTSTATUS_ENA                                                       \
  (DMA_CH0_BASEADDR + 0x080) /* R/W Chan Interrupt Status Enable */
#define CH_INTSTATUS (DMA_CH0_BASEADDR + 0x088) /* R/W Chan Interrupt Status   \
                                                 */
#define CH_INTSIGNAL_ENA                                                       \
  (DMA_CH0_BASEADDR + 0x090) /* R/W Chan Interrupt Signal Enable */

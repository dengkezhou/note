...
//#define E906_DMA_MAP_ADDR1 0x40000000
//#define E906_DMA_MAP_ADDR2 0x100000000
//#endif
...
struct axi_dma_chan {
	...
	u8 id;
	u8 src_hw_handshake_num;
	u8 dst_hw_handshake_num;
...
enum { DWAXIDMAC_CH_CTL_L_INC = 0, DWAXIDMAC_CH_CTL_L_NOINC };
...
enum { DWAXIDMAC_HS_SEL_HW = 0, DWAXIDMAC_HS_SEL_SW };

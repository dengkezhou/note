...
#define DecrementDPBRefCountExt H264_RENAME_FUNC(DecrementDPBRefCountExt)
#define IsBufferReferenced H264_RENAME_FUNC(IsBufferReferenced)
#define IsBufferOutput H264_RENAME_FUNC(IsBufferOutput)
#define MarkOutputPicInfo H264_RENAME_FUNC(MarkOutputPicInfo)
...
#define MarkListNotInUse H264_RENAME_FUNC(MarkListNotInUse)

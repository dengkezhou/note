...
/* parasoft-begin-suppress METRICS-36-3 "A function should not be called from
 * more than 5 different functions, DRV-3823" */
inline static void set64Value(uint32_t *addrL, uint32_t *addrH,
                              uint64_t value) {
...
/* parasoft-begin-suppress METRICS-36-3 "A function should not be called from
 * more than 5 different functions, DRV-3823" */
inline static void USBSSP_WriteDoorbell(USBSSP_DriverResourcesT *res,
                                        uint8_t slotID, uint32_t dbValue) {

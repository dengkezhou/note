...
#include <stdarg.h>
#include <stdio.h>
/* parasoft-begin-suppress MISRA2012-RULE-8_6-2 "An identifier with external
 * linkage shall have exactly one external definition, DRV-4757" */
/* parasoft-begin-suppress MISRA2012-DIR-4_9-4 "A function should be used in
 * preference to a function-like macro where they are interchangeable, DRV-4759"
 */
//#define DEBUG 1
#ifdef DEBUG
 #if DEBUG
...
#define DbgMsg(log_lvl, module, msg, ...)    DbgPrint( msg, ##__VA_ARGS__)
...
#else
#define DbgMsg(log_lvl, module, msg, ...)

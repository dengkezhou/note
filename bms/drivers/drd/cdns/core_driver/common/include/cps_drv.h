 ...
 */
#define CPS_REG_WRITE(reg, value)                                              \
  (CPS_RegWrite((volatile uint32_t *)(reg), (uint32_t)(value)))
 ...
 */
#define CPS_REG_WRITE64(reg, value)                                            \
  (CPS_RegWrite64((volatile uint64_t *)(reg), (uint64_t)(value)))
 ...
 */
#define CPS_FLD_READ(reg, fld, reg_value)                                      \
  (CPS_FldRead((uint32_t)(reg##__##fld##_MASK),                                \
               (uint32_t)(reg##__##fld##_SHIFT), (uint32_t)(reg_value)))
 ...
 */
#define CPS_FLD_WRITE(reg, fld, reg_value, value)                              \
  (CPS_FldWrite((uint32_t)(reg##__##fld##_MASK),                               \
                (uint32_t)(reg##__##fld##_SHIFT), (uint32_t)(reg_value),       \
                (uint32_t)(value)))
 ...
 *  \return   modified register value
 */
#define CPS_FLD_SET(reg, fld, reg_value)                                       \
  (CPS_FldSet((uint32_t)(reg##__##fld##_WIDTH),                                \
              (uint32_t)(reg##__##fld##_MASK),                                 \
              (uint32_t)(reg##__##fld##_WOCLR), (uint32_t)(reg_value)))
...
#define CPS_FLD_CLEAR(reg, fld, reg_value)                                     \
  (CPS_FldClear((uint32_t)(reg##__##fld##_WIDTH),                              \
                (uint32_t)(reg##__##fld##_MASK),                               \
 ...
 *  \return   bit-field value
 */
static inline uint32_t CPS_FldRead(uint32_t mask, uint32_t shift,
                                   uint32_t reg_value) {
 ...
 *  \return   modified register value
 */
static inline uint32_t CPS_FldWrite(uint32_t mask, uint32_t shift,
 ...
 *  \return   modified register value
 */
static inline uint32_t CPS_FldSet(uint32_t width, uint32_t mask,
                                  uint32_t is_woclr, uint32_t reg_value) {
 ...
 *  \return   Modified register value.
 */
static inline uint32_t CPS_FldClear(uint32_t width, uint32_t mask,
                                    uint32_t is_woset, uint32_t is_woclr,
                                    uint32_t reg_value) {
  uint32_t new_value = reg_value;

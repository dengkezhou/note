 ...
 * CUSBD_Usb20ExtensionDescriptor */
#define CH9_USB_USB20_EXT_LPM_SUPPORT (1U << 1U)

/** Describe BESL ALT HIRD defined in bmAttribues field of
 * CUSBD_Usb20ExtensionDescriptor */
#define CH9_USB_USB20_EXT_BESL_ALT_HIRD (1U << 2U)

/** Describe supports LTM defined in bmAttribues field of
 * CUSBD_UsbSuperSpeedDeviceCapabilityDescriptor */
#define CH9_USB_SS_CAP_LTM (1U << 1U)

/** Describe speed supported defined in wSpeedSupported field of
 * CUSBD_UsbSuperSpeedDeviceCapabilityDescriptor */
 ...
 * CUSBD_UsbSuperSpeedPlusDescriptor */

 ...
 **********************************************************************/
/** Structure describes USB request (SETUP packet). See USB Specification
 * (chapter 9.3) */
...
/** Standard SuperSpeed Endpoint Companion Descriptor (see Table 9-26 of USB
 * Spec 3.1) */
...
/** Standard Other_Speed_Configuration descriptor (see Table 9-11 of USB
 * Spec 2.0) */

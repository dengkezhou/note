 ...
 **********************************************************************/
/** Configuration of Auxiliary-overflow buffers for EP-OUT endpoints. This
 * structure is software related. */
...
struct CUSBD_Config_s {
  ...
  /**
   * hardware feature enabling DMA operation in DMULT mode 1 - enabled, 0
   * disabled For Device V1: A non-zero value of dmultEnabled enables DMULT mode
   * for all channels For Device V3:  Bits[15:0]: Control DMULT enable for
   * EP-Out[15:0] Bits[31:16]: Control DMULT enable for EP-In[15:0]
   */

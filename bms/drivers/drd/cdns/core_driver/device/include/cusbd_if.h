...
/** Inactivity timeout value corresponding to max value of
 ...
 */
typedef uint32_t (*CUSBD_CbEpEnable)(CUSBD_PrivateData *pD, CUSBD_Ep *ep,
                                     const uint8_t *desc);
 ...
 */
typedef uint32_t (*CUSBD_CbEpSetHalt)(CUSBD_PrivateData *pD, const CUSBD_Ep *ep,
                                      uint8_t value);
 ...
 * event.
 */
typedef uint32_t (*CUSBD_CbEpSetWedge)(CUSBD_PrivateData *pD,
                                       const CUSBD_Ep *ep);
 ...
 */
typedef uint32_t (*CUSBD_CbEpFifoStatus)(const CUSBD_PrivateData *pD,
                                         const CUSBD_Ep *ep);

/** Flush hardware endpoint FIFO. */
typedef uint32_t (*CUSBD_CbEpFifoFlush)(CUSBD_PrivateData *pD,
                                        const CUSBD_Ep *ep);

/** Submits IN/OUT transfer request to an endpoint. */
typedef uint32_t (*CUSBD_CbReqQueue)(CUSBD_PrivateData *pD, const CUSBD_Ep *ep,
                                     CUSBD_Req *req);
 ...
 */
typedef uint32_t (*CUSBD_CbReqDequeue)(CUSBD_PrivateData *pD, CUSBD_Ep *ep,
                                       CUSBD_Req *req);

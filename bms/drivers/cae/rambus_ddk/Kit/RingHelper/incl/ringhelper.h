 ...
 * recover.
 */
typedef int (* RingHelperCB_WriteFunc_t)(cae_device *dev,
 ...
 * recover.
 */
typedef int (* RingHelperCB_ReadFunc_t)(cae_device *dev,
                    void * const CallbackParam1_p,
                    const int CallbackParam2,
 ...
 * recover.
 */
typedef int (* RingHelperCB_StatusFunc_t)(cae_device *dev,
                    void * const CallbackParam1_p,
                    const int CallbackParam2,

...
EIP202_CDR_Read32(cae_device *dev,
 ...
 */
static inline void
EIP202_CDR_Write32(cae_device *dev,
        Device_Handle_t Device,
        const unsigned int Offset,
...
static inline void
EIP202_CDR_STAT_RD(cae_device *dev,
        Device_Handle_t Device,
        ...
        uint16_t * const CDFIFOWordCount)
{
    ...
    RegVal = EIP202_CDR_Read32(dev, Device, EIP202_CDR_STAT);
...
static inline void
EIP202_CDR_STAT_FIFO_SIZE_RD(cae_device *dev,
        Device_Handle_t Device,
        uint16_t * const CDFIFOWordCount)
{
    uint32_t RegVal;
...
static inline void
EIP202_CDR_STAT_CLEAR_ALL_IRQ_WR(cae_device *dev,
        Device_Handle_t Device)
{
    EIP202_CDR_Write32(dev, Device,
                       EIP202_CDR_STAT,
...
static inline void
EIP202_CDR_RING_BASE_ADDR_LO_DEFAULT_WR(cae_device *dev,
        Device_Handle_t Device)
{
    EIP202_CDR_Write32(dev, Device,
...
static inline void
EIP202_CDR_RING_BASE_ADDR_LO_WR(cae_device *dev,
        Device_Handle_t Device,
        const uint32_t LowAddr)
{
    EIP202_CDR_Write32(dev, Device, EIP202_CDR_RING_BASE_ADDR_LO, LowAddr);
}


static inline void
EIP202_CDR_RING_BASE_ADDR_HI_DEFAULT_WR(cae_device *dev,
        Device_Handle_t Device)
{
    EIP202_CDR_Write32(dev, Device,
...
static inline void
EIP202_CDR_RING_BASE_ADDR_HI_WR(cae_device *dev,
        Device_Handle_t Device,
        const uint32_t HiAddr)
{
    EIP202_CDR_Write32(dev, Device, EIP202_CDR_RING_BASE_ADDR_HI, HiAddr);
}


static inline void
EIP202_CDR_RING_SIZE_DEFAULT_WR(cae_device *dev,
        Device_Handle_t Device)
{
    EIP202_CDR_Write32(dev, Device,
...
static inline void
EIP202_CDR_RING_SIZE_WR(cae_device *dev,
        Device_Handle_t Device,
        const uint32_t CDRWordCount)
{
    ...
    EIP202_CDR_Write32(dev, Device, EIP202_CDR_RING_SIZE, RegVal);
}


static inline void
EIP202_CDR_DESC_SIZE_DEFAULT_WR(cae_device *dev,
        Device_Handle_t Device)
{
    EIP202_CDR_Write32(dev, Device,
...
static inline void
EIP202_CDR_DESC_SIZE_WR(cae_device *dev,
        Device_Handle_t Device,
        ...
        const bool f64bit)
{
    ...
    EIP202_CDR_Write32(dev, Device, EIP202_CDR_DESC_SIZE, RegVal);
}


static inline void
EIP202_CDR_CFG_DEFAULT_WR(cae_device *dev,
        Device_Handle_t Device)
{
    EIP202_CDR_Write32(dev, Device,
                       EIP202_CDR_CFG,
...
static inline void
EIP202_CDR_CFG_WR(cae_device *dev,
        Device_Handle_t Device,
        ...
        const uint16_t CDFetchThreshWordCount)
{
    ...
    EIP202_CDR_Write32(dev, Device, EIP202_CDR_CFG, RegVal);
}


static inline void
EIP202_CDR_DMA_CFG_DEFAULT_WR(cae_device *dev,
        Device_Handle_t Device)
{
    EIP202_CDR_Write32(dev, Device,
                       EIP202_CDR_DMA_CFG,
...
static inline void
EIP202_CDR_DMA_CFG_WR(cae_device *dev,
        Device_Handle_t Device,
        ...
        const uint8_t AcdProtection)
{
    ...
    EIP202_CDR_Write32(dev, Device, EIP202_CDR_DMA_CFG, RegVal);
}


static inline void
EIP202_CDR_THRESH_DEFAULT_WR(cae_device *dev,
        Device_Handle_t Device)
{
    EIP202_CDR_Write32(dev, Device,
                       EIP202_CDR_THRESH,
...
static inline void
EIP202_CDR_THRESH_WR(cae_device *dev,
        Device_Handle_t Device,
        ...
        const uint8_t CDTimeout)
{
    ...
    EIP202_CDR_Write32(dev, Device, EIP202_CDR_THRESH, RegVal);
}


static inline void
EIP202_CDR_COUNT_DEFAULT_WR(cae_device *dev,
        Device_Handle_t Device)
{
    EIP202_CDR_Write32(dev, Device,
                       EIP202_CDR_COUNT,
...
static inline void
EIP202_CDR_COUNT_WR(cae_device *dev,
        Device_Handle_t Device,
        ...
        const bool fClearCount)
{
    ...
    EIP202_CDR_Write32(dev, Device, EIP202_CDR_COUNT, RegVal);
}


static inline void
EIP202_CDR_COUNT_RD(cae_device *dev,
        Device_Handle_t Device,
        uint32_t * const CDWordCount_p)
{
    uint32_t RegVal;

    RegVal = EIP202_CDR_Read32(dev, Device, EIP202_CDR_COUNT);
...
static inline void
EIP202_CDR_PROC_COUNT_DEFAULT_WR(cae_device *dev,
        Device_Handle_t Device)
{
    EIP202_CDR_Write32(dev, Device,
...
static inline void
EIP202_CDR_PROC_COUNT_WR(cae_device *dev,
        Device_Handle_t Device,
        ...
        const bool fClearCount)
{
    ...
    EIP202_CDR_Write32(dev, Device, EIP202_CDR_PROC_COUNT, RegVal);
}


static inline void
EIP202_CDR_PROC_COUNT_RD(cae_device *dev,
        Device_Handle_t Device,
        ...
        uint8_t * const ProcPktCount_p)
{
    ...
    RegVal = EIP202_CDR_Read32(dev, Device, EIP202_CDR_PROC_COUNT);
...
static inline void
EIP202_CDR_POINTER_DEFAULT_WR(cae_device *dev,
        Device_Handle_t Device)
{
    EIP202_CDR_Write32(dev, Device,
                       EIP202_CDR_POINTER,
...
static inline void
EIP202_CDR_POINTER_RD(cae_device *dev,
        Device_Handle_t Device,
        uint32_t * const CDRPointer_p)
{
    uint32_t RegVal;

    RegVal = EIP202_CDR_Read32(dev, Device, EIP202_CDR_POINTER);
...
static inline void
EIP202_CDR_OPTIONS_RD(cae_device *dev,
        Device_Handle_t Device,
        ...
        bool * const fAddr64)
{
    ...
    RevRegVal = EIP202_CDR_Read32(dev, Device, EIP202_CDR_OPTIONS);

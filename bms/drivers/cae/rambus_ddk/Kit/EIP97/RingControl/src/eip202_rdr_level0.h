...
extern void Device_Write32(cae_device *dev,
...
EIP202_RDR_Read32(cae_device *dev,
 ...
 */
static inline void
EIP202_RDR_Write32(cae_device *dev,
        Device_Handle_t Device,
        const unsigned int Offset,
...
static inline void
EIP202_RDR_RING_BASE_ADDR_LO_DEFAULT_WR(cae_device *dev,
        Device_Handle_t Device)
{
...
static inline void
EIP202_RDR_RING_BASE_ADDR_LO_WR(cae_device *dev,
        Device_Handle_t Device,
        const uint32_t LowAddr)
{
    EIP202_RDR_Write32(dev, Device, EIP202_RDR_RING_BASE_ADDR_LO, LowAddr);
}


static inline void
EIP202_RDR_RING_BASE_ADDR_HI_DEFAULT_WR(cae_device *dev,
        Device_Handle_t Device)
{
    EIP202_RDR_Write32(dev, Device,
...
static inline void
EIP202_RDR_RING_BASE_ADDR_HI_WR(cae_device *dev,
        Device_Handle_t Device,
        const uint32_t HiAddr)
{
    EIP202_RDR_Write32(dev, Device, EIP202_RDR_RING_BASE_ADDR_HI, HiAddr);
}


static inline void
EIP202_RDR_RING_SIZE_DEFAULT_WR(cae_device *dev,
        Device_Handle_t Device)
{
    EIP202_RDR_Write32(dev, Device,
...
static inline void
EIP202_RDR_RING_SIZE_WR(cae_device *dev,
        Device_Handle_t Device,
        const uint32_t RDRWordCount)
{
    ...
    EIP202_RDR_Write32(dev, Device, EIP202_RDR_RING_SIZE, RegVal);
}


static inline void
EIP202_RDR_DESC_SIZE_DEFAULT_WR(cae_device *dev,
        Device_Handle_t Device)
{
    EIP202_RDR_Write32(dev, Device,
...
static inline void
EIP202_RDR_DESC_SIZE_WR(cae_device *dev,
        Device_Handle_t Device,
        ...
        const bool f64bit)
{
    ...
    EIP202_RDR_Write32(dev, Device, EIP202_RDR_DESC_SIZE, RegVal);
}


static inline void
EIP202_RDR_CFG_DEFAULT_WR(cae_device *dev,
        Device_Handle_t Device)
{
    EIP202_RDR_Write32(dev, Device,
                       EIP202_RDR_CFG,
...
static inline void
EIP202_RDR_CFG_WR(cae_device *dev,
        Device_Handle_t Device,
        ...
        const bool fOwnEnable)
{
    ...
    EIP202_RDR_Write32(dev, Device, EIP202_RDR_CFG, RegVal);
}


static inline void
EIP202_RDR_DMA_CFG_DEFAULT_WR(cae_device *dev,
        Device_Handle_t Device)
{
    EIP202_RDR_Write32(dev, Device,
                       EIP202_RDR_DMA_CFG,
...
static inline void
EIP202_RDR_DMA_CFG_WR(cae_device *dev,
        Device_Handle_t Device,
        ...
        const bool fPadToOffset)
{
    ...
    EIP202_RDR_Write32(dev, Device, EIP202_RDR_DMA_CFG, RegVal);
}


static inline void
EIP202_RDR_THRESH_DEFAULT_WR(cae_device *dev,
        Device_Handle_t Device)
{
    EIP202_RDR_Write32(dev, Device,
                       EIP202_RDR_THRESH,
...
static inline void
EIP202_RDR_THRESH_WR(cae_device *dev,
        Device_Handle_t Device,
        ...
        const uint8_t RDTimeout)
{
    ...
    EIP202_RDR_Write32(dev, Device, EIP202_RDR_THRESH, RegVal);
}


static inline void
EIP202_RDR_PREP_COUNT_DEFAULT_WR(cae_device *dev,
        Device_Handle_t Device)
{
    EIP202_RDR_Write32(dev, Device,
...
static inline void
EIP202_RDR_PREP_COUNT_WR(cae_device *dev,
        Device_Handle_t Device,
        ...
        const bool fClearCount)
{
    ...
    EIP202_RDR_Write32(dev, Device, EIP202_RDR_PREP_COUNT, RegVal);
}


static inline void
EIP202_RDR_PREP_COUNT_RD(cae_device *dev,
        Device_Handle_t Device,
        uint32_t * const PrepRDWordCount_p)
{
    uint32_t RegVal;

    RegVal = EIP202_RDR_Read32(dev, Device, EIP202_RDR_PREP_COUNT);
...
static inline void
EIP202_RDR_PROC_COUNT_DEFAULT_WR(cae_device *dev,
        Device_Handle_t Device)
{
    EIP202_RDR_Write32(dev, Device,
...
static inline void
EIP202_RDR_PROC_COUNT_WR(cae_device *dev,
        Device_Handle_t Device,
        ...
        const bool fClearCount)
{
    ...
    EIP202_RDR_Write32(dev, Device, EIP202_RDR_PROC_COUNT, RegVal);
}


static inline void
EIP202_RDR_PROC_COUNT_RD(cae_device *dev,
        Device_Handle_t Device,
        ...
        uint8_t * const ProcPktWordCount_p)
{
    ...
    RegVal = EIP202_RDR_Read32(dev, Device, EIP202_RDR_PROC_COUNT);
...
static inline void
EIP202_RDR_PREP_PNTR_DEFAULT_WR(cae_device *dev,
        Device_Handle_t Device)
{
    EIP202_RDR_Write32(dev, Device,
...
static inline void
EIP202_RDR_PROC_PNTR_DEFAULT_WR(cae_device *dev,
        Device_Handle_t Device)
{
    EIP202_RDR_Write32(dev, Device,
...
static inline void
EIP202_RDR_STAT_RD(cae_device *dev,
        Device_Handle_t Device,
        ...
        uint16_t * const RDFIFOWordCount)
{
    ...
    RegVal = EIP202_RDR_Read32(dev, Device, EIP202_RDR_STAT);
...
static inline void
EIP202_RDR_STAT_FIFO_SIZE_RD(cae_device *dev,
        Device_Handle_t Device,
        uint16_t * const RDFIFOWordCount)
{
    uint32_t RegVal;
...
static inline void
EIP202_RDR_STAT_CLEAR_ALL_IRQ_WR(cae_device *dev,
        Device_Handle_t Device)
{
    EIP202_RDR_Write32(dev, Device,
                       EIP202_RDR_STAT,
...
static inline void
EIP202_RDR_STAT_CLEAR_DSCR_BUF_OFLO_IRQ_WR(cae_device *dev,
        Device_Handle_t Device)
{
    EIP202_RDR_Write32(dev, Device,
                       EIP202_RDR_STAT,

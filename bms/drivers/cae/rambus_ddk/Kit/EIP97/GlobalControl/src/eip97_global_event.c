...
EIP97_Global_DFE_Status_Get(cae_device *dev,
        ...
        EIP97_Global_DFE_Status_t * const DFE_Status_p)
{
    ...
    EIP202_DFE_TRD_STAT_RD(dev, Device,
                           PE_Number,
 ...
 */
EIP97_Global_Error_t
EIP97_Global_DSE_Status_Get(cae_device *dev,
        EIP97_Global_IOArea_t * const IOArea_p,
        const unsigned int PE_Number,
        EIP97_Global_DSE_Status_t * const DSE_Status_p)
{
    ...
    EIP202_DSE_TRD_STAT_RD(dev, Device,
                           PE_Number,
 ...
 */
EIP97_Global_Error_t
EIP97_Global_EIP96_Token_Status_Get(cae_device *dev,
        EIP97_Global_IOArea_t * const IOArea_p,
        const unsigned int PE_Number,
        EIP96_Token_Status_t * const Token_Status_p)
{
    ...
    EIP96_TOKEN_CTRL_STAT_RD(dev, Device,
                             PE_Number,
 ...
 */
EIP97_Global_Error_t
EIP97_Global_EIP96_Context_Status_Get(cae_device *dev,
        EIP97_Global_IOArea_t * const IOArea_p,
        const unsigned int PE_Number,
        EIP96_Context_Status_t * const Context_Status_p)
{
    ...
    EIP96_CONTEXT_STAT_RD(dev, Device,
                          PE_Number,
 ...
 */
EIP97_Global_Error_t
EIP97_Global_EIP96_OutXfer_Status_Get(cae_device *dev,
        EIP97_Global_IOArea_t * const IOArea_p,
        const unsigned int PE_Number,
        EIP96_Output_Transfer_Status_t * const OutXfer_Status_p)
{
    ...
    EIP96_OUT_TRANS_CTRL_STAT_RD(dev, Device,
                                 PE_Number,
 ...
 */
EIP97_Global_Error_t
EIP97_Global_EIP96_PRNG_Status_Get(cae_device *dev,
        EIP97_Global_IOArea_t * const IOArea_p,
        const unsigned int PE_Number,

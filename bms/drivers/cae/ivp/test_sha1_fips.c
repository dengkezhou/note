...
*((unsigned int *)((unsigned long)context_ptr+0x00006008))=0x010a0002;
*((unsigned int *)((unsigned long)context_ptr+0x00006008+4*1))=0x00000001;
*((unsigned int *)((unsigned long)context_ptr+0x00006010))=0x010a0012;
...
*((unsigned int *)((unsigned long)context_ptr+0x00006010+4*3))=0x21e60014;
...
*((unsigned int *)((unsigned long)context_ptr+0x00000000+4*4))=0x063b8a89;
...
*((unsigned int *)((unsigned long)context_ptr+0x00006038))=0x010a0012;
*((unsigned int *)((unsigned long)context_ptr+0x00006038+4*1))=0x00000001;
*((unsigned int *)((unsigned long)context_ptr+0x00006038+4*2))=0x02020038;
*((unsigned int *)((unsigned long)context_ptr+0x00006038+4*3))=0x21e60014;
*((unsigned int *)((unsigned long)context_ptr+0x00006048))=0x64636261;
*((unsigned int *)((unsigned long)context_ptr+0x00006048+4*1))=0x65646362;
*((unsigned int *)((unsigned long)context_ptr+0x00006048+4*2))=0x66656463;
*((unsigned int *)((unsigned long)context_ptr+0x00006048+4*3))=0x67666564;
*((unsigned int *)((unsigned long)context_ptr+0x00006048+4*4))=0x68676665;
*((unsigned int *)((unsigned long)context_ptr+0x00006048+4*5))=0x69686766;
*((unsigned int *)((unsigned long)context_ptr+0x00006048+4*6))=0x6a696867;
*((unsigned int *)((unsigned long)context_ptr+0x00006048+4*7))=0x6b6a6968;
*((unsigned int *)((unsigned long)context_ptr+0x00006048+4*8))=0x6c6b6a69;
*((unsigned int *)((unsigned long)context_ptr+0x00006048+4*9))=0x6d6c6b6a;
*((unsigned int *)((unsigned long)context_ptr+0x00006048+4*10))=0x6e6d6c6b;
*((unsigned int *)((unsigned long)context_ptr+0x00006048+4*11))=0x6f6e6d6c;
*((unsigned int *)((unsigned long)context_ptr+0x00006048+4*12))=0x706f6e6d;
*((unsigned int *)((unsigned long)context_ptr+0x00006048+4*13))=0x71706f6e;
*((unsigned int *)((unsigned long)context_ptr+0x00003018))=0x04c00014;
*((unsigned int *)((unsigned long)context_ptr+0x00003018+4*1))=0x00006080;
...
*((unsigned int *)((unsigned long)context_ptr+0x00000018+4*4))=0x00b36f3c;
...
if(!memcmp((unsigned char *)context_ptr+0x00006024,"\xa9\x99\x3e\x36\x47\x06\x81\x6a\xba\x3e\x25\x71\x78\x50\xc2\x6c\x9c\xd0\xd8\x9d",20))
printf("strip: a9993e364706816a, Pass\n");
else
printf("strip: a9993e364706816a, Failed\n");
...
readl(ivp_cae_base_addr+0x00000830);
writel(0x00000010&0xffffffff,ivp_cae_base_addr+0x0000083c);
if(!memcmp((unsigned char *)context_ptr+0x00006080,"\x84\x98\x3e\x44\x1c\x3b\xd2\x6e\xba\xae\x4a\xa1\xf9\x51\x29\xe5\xe5\x46\x70\xf1",20))
printf("strip: 84983e441c3bd26e, Pass\n");
else
printf("strip: 84983e441c3bd26e, Failed\n");
}

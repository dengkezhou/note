...
#define CMD_DSCR_PKT_LEN 0x1fffc
...
void enable_cae_module(void)
{
	itcs_module_enable(CPU, "cae");
}

void make_input_data(int enc)
{
	int i = 0, j = 0;
	...
	if (CMD_DSCR_PKT_LEN % 64 == 0) {
		len = CMD_DSCR_PKT_LEN / 64;
	} else {
		len = CMD_DSCR_PKT_LEN / 64 + 1;
	}

	if (enc) {
		for (i = 0; i < len; i++) {
			*((unsigned int *)((unsigned long)cd->context_ptr+0x0000609c+4*j))=0xe2bec16b;
			j++;
			*((unsigned int *)((unsigned long)cd->context_ptr+0x0000609c+4*j))=0x969f402e;
			j++;
			*((unsigned int *)((unsigned long)cd->context_ptr+0x0000609c+4*j))=0x117e3de9;
			j++;
			*((unsigned int *)((unsigned long)cd->context_ptr+0x0000609c+4*j))=0x2a179373;
			j++;
			*((unsigned int *)((unsigned long)cd->context_ptr+0x0000609c+4*j))=0x578a2dae;
			j++;
			*((unsigned int *)((unsigned long)cd->context_ptr+0x0000609c+4*j))=0x9cac031e;
			j++;
			*((unsigned int *)((unsigned long)cd->context_ptr+0x0000609c+4*j))=0xac6fb79e;
			j++;
			*((unsigned int *)((unsigned long)cd->context_ptr+0x0000609c+4*j))=0x518eaf45;
			j++;
			*((unsigned int *)((unsigned long)cd->context_ptr+0x0000609c+4*j))=0x461cc830;
			j++;
			*((unsigned int *)((unsigned long)cd->context_ptr+0x0000609c+4*j))=0x11e45ca3;
			j++;
			*((unsigned int *)((unsigned long)cd->context_ptr+0x0000609c+4*j))=0x19c1fbe5;
			j++;
			*((unsigned int *)((unsigned long)cd->context_ptr+0x0000609c+4*j))=0xef520a1a;
			j++;
			*((unsigned int *)((unsigned long)cd->context_ptr+0x0000609c+4*j))=0x45249ff6;
			j++;
			*((unsigned int *)((unsigned long)cd->context_ptr+0x0000609c+4*j))=0x179b4fdf;
			j++;
			*((unsigned int *)((unsigned long)cd->context_ptr+0x0000609c+4*j))=0x7b412bad;
			j++;
			*((unsigned int *)((unsigned long)cd->context_ptr+0x0000609c+4*j))=0x10376ce6;
			j++;
		}
	} else {
		for (i = 0; i < len; i++) {
			*((unsigned int *)((unsigned long)cd->context_ptr+0x0000609c+4*j))=0xacab4976;
			j++;
			*((unsigned int *)((unsigned long)cd->context_ptr+0x0000609c+4*j))=0x46b21981;
			j++;
			*((unsigned int *)((unsigned long)cd->context_ptr+0x0000609c+4*j))=0x9b8ee9ce;
			j++;
			*((unsigned int *)((unsigned long)cd->context_ptr+0x0000609c+4*j))=0x7d19e912;
			j++;
			*((unsigned int *)((unsigned long)cd->context_ptr+0x0000609c+4*j))=0x9bcb8650;
			j++;
			*((unsigned int *)((unsigned long)cd->context_ptr+0x0000609c+4*j))=0xee197250;
			j++;
			*((unsigned int *)((unsigned long)cd->context_ptr+0x0000609c+4*j))=0x3a11db95;
			j++;
			*((unsigned int *)((unsigned long)cd->context_ptr+0x0000609c+4*j))=0xb2787691;
			j++;
			*((unsigned int *)((unsigned long)cd->context_ptr+0x0000609c+4*j))=0xb8d6be73;
			j++;
			*((unsigned int *)((unsigned long)cd->context_ptr+0x0000609c+4*j))=0x3b74c1e3;
			j++;
			*((unsigned int *)((unsigned long)cd->context_ptr+0x0000609c+4*j))=0x9ee61671;
			j++;
			*((unsigned int *)((unsigned long)cd->context_ptr+0x0000609c+4*j))=0x16952222;
			j++;
			*((unsigned int *)((unsigned long)cd->context_ptr+0x0000609c+4*j))=0xa1caf13f;
			j++;
			*((unsigned int *)((unsigned long)cd->context_ptr+0x0000609c+4*j))=0x09ac1f68;
			j++;
			*((unsigned int *)((unsigned long)cd->context_ptr+0x0000609c+4*j))=0x30ca0e12;
			j++;
			*((unsigned int *)((unsigned long)cd->context_ptr+0x0000609c+4*j))=0xa7e18675;
			j++;
		}
	}
}

static void make_input_data_for_rtl(core_desc *cd, int enc)
{
	int i = 0, j = 0;
	unsigned int len = 0;
...
static void core_prepare_for_fpga(core_desc *cd)
{
if(!cd->context_ptr)
...
*((unsigned int *)((unsigned long)cd->context_ptr+0x00006090+4*2))=0x0d060000 | CMD_DSCR_PKT_LEN;

*((unsigned int *)((unsigned long)cd->context_ptr+0x00003000))=0x04c00000 | CMD_DSCR_PKT_LEN;
*((unsigned int *)((unsigned long)cd->context_ptr+0x00003000+4*1))=0x00100000;
...
*((unsigned int *)((unsigned long)cd->context_ptr+0x00000000))=0x03c00000 | CMD_DSCR_PKT_LEN;
...
*((unsigned int *)((unsigned long)cd->context_ptr+0x00000000+4*3))=0x02220000 | CMD_DSCR_PKT_LEN;
...
//	printf("%02x ", ((unsigned char *)((unsigned char *)cd->context_ptr+0x00100000))[i]);
//	if (((i + 1) % 16) == 0)
//		printf("\n");
//}
//while (1);
...
static void core_dec_prepare_for_fpga(core_desc *cd)
{
if(!cd->context_ptr)
printf("cd->context_ptr malloc failed!\n");
#if defined(CONFIG_COMPILE_FPGA) || defined(CONFIG_COMPILE_ASIC)
...
static void core_dec_start_for_fpga(core_desc *cd)
{
writel(0x00000018&0xffffffff,cd->ivp_cae_base_addr+0x0000002c);
writel(0x00000006&0xffffffff,cd->ivp_cae_base_addr+0x00000828);
}

static void core_dec_finish_for_fpga(core_desc *cd)
{
while(1){
if((readl(cd->ivp_cae_base_addr+0x0000083c)&0x00000010)==0x00000010)
break;
...
/* test packet len: 0x1fffc = 131068 bytes. */
void dual_core_test_for_rtl(int enc)
{
	core_desc core_0 = { .context_ptr = (unsigned int *)0x14000000,
			     .ivp_cae_base_addr = ITCS_C_CAE0_BASE };
	...
	make_input_data_for_rtl(&core_0, enc);
	make_input_data_for_rtl(&core_1, enc);
	printf("generate input data done\n");
	if (enc) {
		core_prepare_for_fpga(&core_0);
		core_prepare_for_fpga(&core_1);
		core_start_for_fpga(&core_0);
		core_start_for_fpga(&core_1);
		core_finish_for_fpga(&core_0);
		core_finish_for_fpga(&core_1);
	} else {
		core_dec_prepare_for_fpga(&core_0);
		core_dec_prepare_for_fpga(&core_1);
		core_dec_start_for_fpga(&core_0);
		core_dec_start_for_fpga(&core_1);
		core_dec_finish_for_fpga(&core_0);
		core_dec_finish_for_fpga(&core_1);
	}
	printf("ivp dual core %s Pass.\n", enc ? "enc" : "dec");
}

void cae_ivp_fpga_speed_test(int enc)
{
	core_desc core_0 = { .context_ptr = (unsigned int *)0x14000000,
			     .ivp_cae_base_addr = ITCS_C_CAE0_BASE };

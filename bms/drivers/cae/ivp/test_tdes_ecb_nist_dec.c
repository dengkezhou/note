...
void test_tdes_ecb_nist_dec(void)
{
unsigned int *context_ptr=(unsigned int *)0x14000000;
printf("test_tdes_ecb_nist_dec\n");
if(!context_ptr)
...
*((unsigned int *)((unsigned long)context_ptr+0x00006000))=0x01050605;
...
*((unsigned int *)((unsigned long)context_ptr+0x00006020))=0x01050605;
...
*((unsigned int *)((unsigned long)context_ptr+0x0000602c))=0x8cfd26a8;
*((unsigned int *)((unsigned long)context_ptr+0x0000602c+4*1))=0x5f853be5;
*((unsigned int *)((unsigned long)context_ptr+0x0000602c+4*2))=0x811ce2cc;
*((unsigned int *)((unsigned long)context_ptr+0x0000602c+4*3))=0xe66f2512;
*((unsigned int *)((unsigned long)context_ptr+0x0000602c+4*4))=0x5dc0d568;
*((unsigned int *)((unsigned long)context_ptr+0x0000602c+4*5))=0x00b9b6d9;
...
if(!memcmp((unsigned char *)context_ptr+0x00006044,"\x54\x68\x65\x20\x71\x75\x66\x63\x6b\x20\x62\x72\x6f\x77\x6e\x20\x66\x6f\x78\x20\x6a\x75\x6d\x70",24))
printf("strip: 5468652071756663, Pass\n");
else
printf("strip: 5468652071756663, Failed\n");
}

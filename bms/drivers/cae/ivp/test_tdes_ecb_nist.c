...
void test_tdes_ecb_nist(void)
{
unsigned int *context_ptr=(unsigned int *)0x14000000;
printf("test_tdes_ecb_nist\n");
if(!context_ptr)
...
*((unsigned int *)((unsigned long)context_ptr+0x00006000+4*2))=0x67452301;
*((unsigned int *)((unsigned long)context_ptr+0x00006000+4*3))=0xefcdab89;
*((unsigned int *)((unsigned long)context_ptr+0x00006000+4*4))=0x89674523;
*((unsigned int *)((unsigned long)context_ptr+0x00006000+4*5))=0x01efcdab;
*((unsigned int *)((unsigned long)context_ptr+0x00006000+4*6))=0xab896745;
*((unsigned int *)((unsigned long)context_ptr+0x00006000+4*7))=0x2301efcd;
...
*((unsigned int *)((unsigned long)context_ptr+0x00006020+4*2))=0x0d060018;
*((unsigned int *)((unsigned long)context_ptr+0x0000602c))=0x20656854;
*((unsigned int *)((unsigned long)context_ptr+0x0000602c+4*1))=0x63667571;
*((unsigned int *)((unsigned long)context_ptr+0x0000602c+4*2))=0x7262206b;
*((unsigned int *)((unsigned long)context_ptr+0x0000602c+4*3))=0x206e776f;
*((unsigned int *)((unsigned long)context_ptr+0x0000602c+4*4))=0x20786f66;
*((unsigned int *)((unsigned long)context_ptr+0x0000602c+4*5))=0x706d756a;
*((unsigned int *)((unsigned long)context_ptr+0x00003000))=0x04c00018;
...
*((unsigned int *)((unsigned long)context_ptr+0x00000000))=0x03c00018;
...
*((unsigned int *)((unsigned long)context_ptr+0x00000000+4*3))=0x02220018;
*((unsigned int *)((unsigned long)context_ptr+0x00000000+4*4))=0x0072d3cc;
...
if(!memcmp((unsigned char *)context_ptr+0x00006044,"\xa8\x26\xfd\x8c\xe5\x3b\x85\x5f\xcc\xe2\x1c\x81\x12\x25\x6f\xe6\x68\xd5\xc0\x5d\xd9\xb6\xb9\x00",24))
printf("strip: a826fd8ce53b855f, Pass\n");
else
printf("strip: a826fd8ce53b855f, Failed\n");
}

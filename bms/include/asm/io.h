...
static inline void *phys_to_virt(phys_addr_t phys) { return (void *)phys; }
...
#define __arch_getq(a) (*(volatile uint64_t *)((unsigned long)(a)))

#define __arch_putb(v, a) (*(volatile unsigned char *)(a) = (v))
#define __arch_putw(v, a) (*(volatile unsigned short *)(a) = (v))
#define __arch_putl(v, a) (*(volatile unsigned int *)((unsigned long)(a)) = (v))
#define __arch_putq(v, a) (*(volatile uint64_t *)((unsigned long)(a)) = (v))
...
#endif
static inline uint32_t nbits_readl(unsigned long addr, uint32_t mask,
                                   int offset) {
  return ((readl(addr) & mask) >> offset);
}

static inline void nbits_writel(unsigned long addr, uint32_t mask, int offset,
                                uint32_t val) {
  uint32_t tmp;

...
#define TI_PREEMPT                                                             \
  80                      /* offsetof(struct thread_info, preempt_count)	// */
...
#define THREAD_CPU_CONTEXT                                                     \
  896 /* offsetof(struct task_struct, thread.cpu_context)	// */
...
#define VDSO_CS_CYCLE_LAST                                                     \
  0 /* offsetof(struct vdso_data, cs_cycle_last)	// */
#define VDSO_XTIME_CLK_SEC                                                     \
  8 /* offsetof(struct vdso_data, xtime_clock_sec)	// */
#define VDSO_XTIME_CLK_NSEC                                                    \
  16 /* offsetof(struct vdso_data, xtime_clock_nsec)	// */
#define VDSO_XTIME_CRS_SEC                                                     \
  24 /* offsetof(struct vdso_data, xtime_coarse_sec)	// */
#define VDSO_XTIME_CRS_NSEC                                                    \
  32 /* offsetof(struct vdso_data, xtime_coarse_nsec)	// */
#define VDSO_WTM_CLK_SEC                                                       \
  40 /* offsetof(struct vdso_data, wtm_clock_sec)	// */
#define VDSO_WTM_CLK_NSEC                                                      \
  48 /* offsetof(struct vdso_data, wtm_clock_nsec)	// */
#define VDSO_TB_SEQ_COUNT                                                      \
  56                     /* offsetof(struct vdso_data, tb_seq_count)	// */
#define VDSO_CS_MULT  60 /* offsetof(struct vdso_data, cs_mult)	// */
#define VDSO_CS_SHIFT 64 /* offsetof(struct vdso_data, cs_shift)	// */
#define VDSO_TZ_MINWEST                                                        \
  68                        /* offsetof(struct vdso_data, tz_minuteswest)	// */

...
#define set_cr(x)                                                              \
  __asm__ __volatile__("mcr	p15, 0, %0, c1, c0	@ set CR" : : "r"(x))
...
#define local_irq_enable()                                                     \
  ({                                                                           \
    unsigned long temp;                                                        \
    __asm__ __volatile__("mrs	%0, cpsr		@ local_irq_enable\n"                  \
                         "	bic	%0, %0, #128\n"                                 \
                         "	msr	cpsr_c, %0"                                     \
                         : "=r"(temp)                                          \
                         :                                                     \
...
#define local_irq_disable()                                                    \
  ({                                                                           \
    unsigned long temp;                                                        \
    __asm__ __volatile__("mrs	%0, cpsr		@ local_irq_disable\n"                 \
                         "	orr	%0, %0, #128\n"                                 \
                         "	msr	cpsr_c, %0"                                     \
                         : "=r"(temp)                                          \
                         :                                                     \
...
#define local_save_flags(x)                                                    \
  ({                                                                           \
    __asm__ __volatile__("mrs	%0, cpsr		@ local_save_flags\n"                  \
                         : "=r"(x)                                             \
                         :                                                     \
                         : "memory");                                          \
  })

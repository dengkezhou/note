...
.macro write32, addr, data ldr r4,
    =\addr ldr r5,
    =\data str r5,
    [r4].endm
    ...
    [r4].endm
         ...
         * macro.
         * The macro is valid for any ARM architeture. The actual time spent in
         * the loop will vary from CPU to CPU though.
         */

        .macro wait_timer,
    time ldr r4, =\time 1 : nop subs r4, r4, #1 bcs 1b.endm

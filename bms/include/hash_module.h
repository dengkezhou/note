...
#define HASH_HASH_ENGINE_SEL                                                   \
  3 /* MD5 SHA1 SHA224 SHA256 MD5-HMAC SHA1-HMAC SHA224-HMAC SHA256-HMAC */
...
extern uint32_t hash_module_init(uint32_t mode, uint32_t msg_high,
                                 uint32_t msg_low);

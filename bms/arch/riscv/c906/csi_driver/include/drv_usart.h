...
typedef enum { USART_INTR_WRITE, USART_INTR_READ } usart_intr_type_e;
...
/**
  ...
  operation completes or error happens. \ref csi_usart_get_status can get
...
/**
  ...
  error happens. \ref csi_usart_get_status can get operation status. \param[in]

...
extern int32_t target_usart_init(int32_t idx, uint64_t *base, uint32_t *irq,
                                 void **handler);
...
/**
  ...
  \return      error code
*/
int32_t csi_usart_config_stopbits(usart_handle_t handle,
...
/**
  ...
  \param[in]   usart_priv usart private to operate.
*/
static void ck_usart_intr_char_timeout(int32_t idx,
                                       ck_usart_priv_t *usart_priv) {
...
void ck_usart_irqhandler(int32_t idx) {
  ...
  case DW_IIR_RECV_DATA: /* interrupt source:receiver data available or receiver
...
/**
  ...
  \return      error code
*/
int32_t csi_usart_config(usart_handle_t handle, uint32_t baud,
...
/**
  ...
  signaled when transfer completes. csi_usart_get_status can indicates if
...
/**
  ...
  value as specified by csi_usart_set_default_tx_value \param[in]   handle usart
...
*/
int32_t csi_usart_receive_query(usart_handle_t handle, void *data,
                                uint32_t num) {
  USART_NULL_PARAM_CHK(handle);
  USART_NULL_PARAM_CHK(data);
...
/**
  ...
  error code
*/
int32_t csi_usart_transfer(usart_handle_t handle, const void *data_out,
...
/**
  ...
  \return      error code
*/
int32_t csi_usart_set_interrupt(usart_handle_t handle, usart_intr_type_e type,
                                int32_t flag) {
  USART_NULL_PARAM_CHK(handle);
...
/**
  ...
  \return      error code
*/
int32_t csi_usart_config_clock(usart_handle_t handle, usart_cpol_e cpol,
                               usart_cpha_e cpha) {
  USART_NULL_PARAM_CHK(handle);
  return ERR_USART(DRV_ERROR_UNSUPPORTED);
}

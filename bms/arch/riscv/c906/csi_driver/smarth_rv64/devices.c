...
int32_t target_usart_init(int32_t idx, uint64_t *base, uint32_t *irq,
                          void **handler) {
...
int32_t target_get_timer_count(void) { return CONFIG_TIMER_NUM; }

int32_t target_get_timer(int32_t idx, uint64_t *base, uint32_t *irq,
                         void **handler) {
...
const static gpio_pin_map_t s_gpio_pin_map[] = {{PA0, 0}, {PA1, 1}, {PA2, 2},
                                                {PA3, 3}, {PA4, 4}, {PA5, 5},
                                                {PA6, 6}, {PA7, 7}};

int32_t target_gpio_port_init(port_name_e port, uint64_t *base, uint32_t *irq,
                              void **handler, uint32_t *pin_num) {
  int i;

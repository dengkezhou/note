...
typedef struct {
  ...
  __IOM uint8_t
      ATTR; /*!< Offset: 0x008 (R/W)  Interrupt set attribute register */
  __IOM uint8_t CTL; /*!< Offset: 0x00C (R/W)  Interrupt control register */
} CLIC_INT_Control;

typedef struct {
  __IOM uint32_t
      CLICCFG : 8; /*!< Offset: 0x000 (R/W)  CLIC configure register */
...
#define PMP_PMPCFG_R_Msk                                                       \
  (0x1UL << PMP_PMPCFG_R_Pos) /*!< PMP PMPCFG: R Mask                          \
                               */

#define PMP_PMPCFG_W_Pos 1U /*!< PMP PMPCFG: W Position */
#define PMP_PMPCFG_W_Msk                                                       \
  (0x1UL << PMP_PMPCFG_W_Pos) /*!< PMP PMPCFG: W Mask                          \
                               */

#define PMP_PMPCFG_X_Pos 2U /*!< PMP PMPCFG: X Position */
#define PMP_PMPCFG_X_Msk                                                       \
  (0x1UL << PMP_PMPCFG_X_Pos) /*!< PMP PMPCFG: X Mask                          \
                               */

#define PMP_PMPCFG_A_Pos 3U /*!< PMP PMPCFG: A Position */
#define PMP_PMPCFG_A_Msk                                                       \
  (0x3UL << PMP_PMPCFG_A_Pos) /*!< PMP PMPCFG: A Mask                          \
                               */

#define PMP_PMPCFG_L_Pos 7U /*!< PMP PMPCFG: L Position */
#define PMP_PMPCFG_L_Msk                                                       \
  (0x1UL << PMP_PMPCFG_L_Pos) /*!< PMP PMPCFG: L Mask                          \
                               */
...
#define CACHE_MHCR_L0BTB_Msk                                                   \
  (0x1UL << CACHE_MHCR_L0BTB_Pos) /*!< CACHE MHCR: WA Mask */

#define CACHE_MHCR_BPE_Pos 5U /*!< CACHE MHCR: BPE Position */
#define CACHE_MHCR_BPE_Msk                                                     \
  (0x1UL << CACHE_MHCR_BPE_Pos) /*!< CACHE MHCR: BPE Mask */

#define CACHE_MHCR_RS_Pos 4U /*!< CACHE MHCR: RS Position */
#define CACHE_MHCR_RS_Msk                                                      \
  (0x1UL << CACHE_MHCR_RS_Pos) /*!< CACHE MHCR: RS Mask */

#define CACHE_MHCR_WA_Pos 3U /*!< CACHE MHCR: WA Position */
#define CACHE_MHCR_WA_Msk                                                      \
  (0x1UL << CACHE_MHCR_WA_Pos) /*!< CACHE MHCR: WA Mask */

#define CACHE_MHCR_WB_Pos 2U /*!< CACHE MHCR: WB Position */
#define CACHE_MHCR_WB_Msk                                                      \
  (0x1UL << CACHE_MHCR_WB_Pos) /*!< CACHE MHCR: WB Mask */

#define CACHE_MHCR_DE_Pos 1U /*!< CACHE MHCR: DE Position */
#define CACHE_MHCR_DE_Msk                                                      \
  (0x1UL << CACHE_MHCR_DE_Pos) /*!< CACHE MHCR: DE Mask */

#define CACHE_MHCR_IE_Pos 0U /*!< CACHE MHCR: IE Position */
#define CACHE_MHCR_IE_Msk                                                      \
  (0x1UL << CACHE_MHCR_IE_Pos) /*!< CACHE MHCR: IE Mask */
...
#define SYSMAP_SYSMAPCFG_B_Msk                                                 \
  (0x1UL << SYSMAP_SYSMAPCFG_B_Pos) /*!< SYSMAP SYSMAPCFG: B Mask */

#define SYSMAP_SYSMAPCFG_C_Pos 1U /*!< SYSMAP SYSMAPCFG: C Position */
#define SYSMAP_SYSMAPCFG_C_Msk                                                 \
  (0x1UL << SYSMAP_SYSMAPCFG_C_Pos) /*!< SYSMAP SYSMAPCFG: C Mask */

#define SYSMAP_SYSMAPCFG_SO_Pos 2U /*!< SYSMAP SYSMAPCFG: SO Position */
#define SYSMAP_SYSMAPCFG_SO_Msk                                                \
  (0x1UL << SYSMAP_SYSMAPCFG_SO_Pos) /*!< SYSMAP SYSMAPCFG: SO Mask */
...
typedef struct {
  __IOM uint32_t
      SYSMAPADDR0; /*!< Offset: 0x000 (R/W)  SYSMAP configure register */
  __IOM uint32_t
      SYSMAPCFG0; /*!< Offset: 0x004 (R/W)  SYSMAP configure register */
  __IOM uint32_t
      SYSMAPADDR1; /*!< Offset: 0x008 (R/W)  SYSMAP configure register */
  __IOM uint32_t
      SYSMAPCFG1; /*!< Offset: 0x00c (R/W)  SYSMAP configure register */
  __IOM uint32_t
      SYSMAPADDR2; /*!< Offset: 0x010 (R/W)  SYSMAP configure register */
  __IOM uint32_t
      SYSMAPCFG2; /*!< Offset: 0x014 (R/W)  SYSMAP configure register */
  __IOM uint32_t
      SYSMAPADDR3; /*!< Offset: 0x018 (R/W)  SYSMAP configure register */
  __IOM uint32_t
      SYSMAPCFG3; /*!< Offset: 0x01c (R/W)  SYSMAP configure register */
  __IOM uint32_t
      SYSMAPADDR4; /*!< Offset: 0x020 (R/W)  SYSMAP configure register */
  __IOM uint32_t
      SYSMAPCFG4; /*!< Offset: 0x024 (R/W)  SYSMAP configure register */
  __IOM uint32_t
      SYSMAPADDR5; /*!< Offset: 0x028 (R/W)  SYSMAP configure register */
  __IOM uint32_t
      SYSMAPCFG5; /*!< Offset: 0x02c (R/W)  SYSMAP configure register */
  __IOM uint32_t
      SYSMAPADDR6; /*!< Offset: 0x030 (R/W)  SYSMAP configure register */
  __IOM uint32_t
      SYSMAPCFG6; /*!< Offset: 0x034 (R/W)  SYSMAP configure register */
  __IOM uint32_t
      SYSMAPADDR7; /*!< Offset: 0x038 (R/W)  SYSMAP configure register */
  __IOM uint32_t
      SYSMAPCFG7; /*!< Offset: 0x03c (R/W)  SYSMAP configure register */
} SYSMAP_Type;
...
typedef struct {
  __IOM uint32_t MSIP;
  uint32_t RESERVED0[0x4000 / 4 - 1];
  __IOM unsigned long long
      MTIMECMP; /*!< Offset: 0x000 (R/W) Timer compare register */
  uint32_t RESERVED[8187];
  __IM unsigned long long
      MTIME; /*!< Offset: 0x7FFC (R)  Timer current register */
} CORET_Type;
...
typedef struct {
  ...
  union {
    __IM uint32_t
        DERJW; /*!< Offset: 0x058 (R/ )  Data exchange register CPU read*/
    __OM uint32_t
        DERJR; /*!< Offset: 0x058 ( /W)  Data exchange register CPU writer*/
  };
...
//#define CORET_BASE          (0xE0004000UL)                            /*!<
// CORET Base Address */ #define CLIC_BASE           (0xE0800000UL) /*!< CLIC
// Base Address */ #define SYSMAP_BASE         (0xEFFFF000UL) /*!< SYSMAP Base
// Address */
...
#define SYSMAP                                                                 \
  ((SYSMAP_Type *)SYSMAP_BASE)           /*!< SYSMAP configuration struct      \
                                          */
...
/**
        ...
        */
__STATIC_INLINE uint32_t csi_softirq_trigger(int en) {
  if (en)
    CORET->MSIP |= 1;
  else
    CORET->MSIP &= ~1;
...
__STATIC_INLINE uint32_t csi_coret_config(uint32_t ticks, int32_t IRQn) {
  if ((CORET->MTIMECMP != 0) && (CORET->MTIMECMP != 0xffffffffffffffff)) {
    ...
    CORET->MTIMECMP = __get_MTIME() + ticks;
  }
  return (0UL);
}

__STATIC_INLINE void csi_coret_stop(void) {
  CORET->MTIMECMP = 0xffffffffffffffff;
}
...
#define MEXSTATUS_RESET_Msk                                                    \
  (0x3UL << MEXSTATUS_RESET_Pos) /*!< MEXSTATUS: RESET Position */
#define MEXSTATUS_SLEEP_Pos 2U
#define MEXSTATUS_SLEEP_Msk                                                    \
  (0x3UL << MEXSTATUS_SLEEP_Pos) /*!< MEXSTATUS: RESET Position */
...
__STATIC_INLINE void csi_icache_enable(void) {
  ...
  /* lite mode do not support invalid */
  __ICACHE_IALL();
#endif
  cache = __get_MHCR();
...
*/
__STATIC_INLINE void csi_dcache_invalid_range(phys_addr_t addr, int32_t dsize) {
#if (__DCACHE_PRESENT == 1U)
...
/**
  ...
  \param[in]   dsize   size of memory block (in number of bytes)
*/
__STATIC_INLINE void csi_dcache_clean_range(phys_addr_t addr, int32_t dsize) {
...
*/
__STATIC_INLINE void csi_dcache_clean_invalid_range(phys_addr_t addr,
                                                    int32_t dsize) {
#if (__DCACHE_PRESENT == 1U)
  int32_t op_size  = dsize + (uint32_t)addr % 32;
  uint32_t op_addr = (uint32_t)addr;

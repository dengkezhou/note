...
__ALWAYS_STATIC_INLINE void __disable_hpm(void) {
  __ASM volatile("li x5, 0xffffffff\n"
                 "csrw mcountinhibit, x5");
}

__ALWAYS_STATIC_INLINE void __enable_hpm(void) {
  __ASM volatile("csrw mcountinhibit, x0");
}
 ...
 */
__ALWAYS_STATIC_INLINE uint64_t __get_MENVCFG(void)
{
    uint64_t result;
 ...
 */
__ALWAYS_STATIC_INLINE void __set_MENVCFG(uint64_t menvcfg)
{
 ...
 */
__ALWAYS_STATIC_INLINE uint64_t __get_MEPC(void)
{
    uint64_t result;
 ...
 */
__ALWAYS_STATIC_INLINE void __set_SEPC(uint64_t sepc)
{
 ...
 */
__ALWAYS_STATIC_INLINE uint64_t __get_SEPC(void)
{
    uint64_t result;
...
/**
  \brief   Get SHCR
  \details Returns the content of the SHCR Register.
  \return               SHCR Register value
 */
__ALWAYS_STATIC_INLINE uint64_t __get_SHCR(void) {
  uint64_t result;

  __ASM volatile("csrr %0, shcr" : "=r"(result));
  return (result);
}
...
__ALWAYS_STATIC_INLINE int is_isa_supported(char ext) {
  uint64_t misa = __get_MISA();
 ...
 */
__ALWAYS_STATIC_INLINE uint64_t __get_SSCRATCH(void) {
  uint64_t result;
 ...
 */
__ALWAYS_STATIC_INLINE void __set_SSCRATCH(uint64_t sscratch) {
...
__STATIC_INLINE void __set_PMPxCFG(uint64_t idx, uint8_t pmpxcfg)
{
    ...
    if (idx < 8) {
        pmpcfgx = __get_PMPCFG0();
        pmpcfgx = (pmpcfgx & ~((uint64_t)0xFF << (idx << 3))) |
                    ((uint64_t)pmpxcfg << (idx << 3));
...
/**
  ...
  \param [in] addr  operate addr
 */
__ALWAYS_STATIC_INLINE void __DCACHE_CISW(uint64_t wayset)
{
...
/**
  ...
  \param [in] addr  operate addr
 */
__ALWAYS_STATIC_INLINE void __DCACHE_CPAL1(uint64_t addr)
{
...
/**
  ...
  \param [in] addr  operate addr
 */
__ALWAYS_STATIC_INLINE void __DCACHE_CVAL1(uint64_t addr)
{
...
/**
  ...
  \param [in] addr  operate addr
 */
__ALWAYS_STATIC_INLINE void __DCACHE_ISW(uint64_t wayset)
{
...
/**
  ...
  */
__ALWAYS_STATIC_INLINE uint64_t __get_SCER2(void)
{
    register uint64_t result;
...
/**
  ...
  */
__ALWAYS_STATIC_INLINE void __set_SCER2(uint64_t scer2)
{
...
/**
  ...
  */
__ALWAYS_STATIC_INLINE uint64_t __get_MCER2(void)
{
    register uint64_t result;
...
/**
  ...
  */
__ALWAYS_STATIC_INLINE void __set_MCER2(uint64_t mcer2)
{
...
/**
  ...
  */
__ALWAYS_STATIC_INLINE uint64_t __get_SSBEPA2(void)
{
    register uint64_t result;
...
/**
  ...
  */
__ALWAYS_STATIC_INLINE void __set_SSBEPA2(uint64_t ssbepa2)
{
...
/**
  ...
  */
__ALWAYS_STATIC_INLINE uint64_t __get_MSBEPA2(void)
{
    register uint64_t result;
...
/**
  ...
  */
__ALWAYS_STATIC_INLINE void __set_MSBEPA2(uint64_t msbepa2)
{
...
/**
  ...
  */
__ALWAYS_STATIC_INLINE uint64_t __get_SCER(void)
{
    register uint64_t result;
...
/**
  ...
  */
__ALWAYS_STATIC_INLINE void __set_SCER(uint64_t scer)
{
...
/**
  ...
  */
__ALWAYS_STATIC_INLINE uint64_t __get_MCER(void)
{
    register uint64_t result;
...
/**
  ...
  */
__ALWAYS_STATIC_INLINE void __set_MCER(uint64_t mcer)
{
...
/**
  ...
  */
__ALWAYS_STATIC_INLINE uint64_t __get_SSBEPA(void)
{
    register uint64_t result;
...
/**
  ...
  */
__ALWAYS_STATIC_INLINE void __set_SSBEPA(uint64_t ssbepa)
{
...
/**
  ...
  */
__ALWAYS_STATIC_INLINE uint64_t __get_MSBEPA(void)
{
    register uint64_t result;
...
/**
  ...
  */
__ALWAYS_STATIC_INLINE void __set_MSBEPA(uint64_t msbepa)
{
...
/**
  ...
  */
__ALWAYS_STATIC_INLINE uint64_t __get_MIESR(void)
{
    register uint64_t result;
...
/**
  ...
  */
__ALWAYS_STATIC_INLINE uint64_t __get_MEICR2(void)
{
    register uint64_t result;
...
/**
  ...
  */
__ALWAYS_STATIC_INLINE void __set_MEICR2(uint64_t meicr2)
{
...
/**
  ...
  */
__ALWAYS_STATIC_INLINE uint64_t __get_MEICR(void)
{
    register uint64_t result;
...
/**
  ...
  */
__ALWAYS_STATIC_INLINE void __set_MEICR(uint64_t meicr)
{
...
/**
  ...
  */
__ALWAYS_STATIC_INLINE uint64_t __get_MITCMCR(void)
{
    uint64_t result;
...
/**
  ...
  */
__ALWAYS_STATIC_INLINE void __set_MITCMCR(uint64_t itcmcr)
{
...
/**
  ...
  */
__ALWAYS_STATIC_INLINE uint64_t __get_MDTCMCR(void)
{
    uint64_t result;
...
/**
  ...
  */
__ALWAYS_STATIC_INLINE void __set_MDTCMCR(uint64_t dtcmcr)
{

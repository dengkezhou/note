...
/**
  \brief       Initialize PWM Interface. 1. Initializes the resources needed for
  the PWM interface 2.registers event callback function \param[in]   idx pwm idx
  \return      handle pwm handle to operate.
*/
pwm_handle_t csi_pwm_initialize(uint32_t idx);

/**
  \brief       De-initialize PWM Interface. stops operation and releases the
  software resources used by the interface \param[in]   handle pwm handle to
  operate.
*/
...
/**
  ...
  \return      error code
*/
int32_t csi_pwm_config(pwm_handle_t handle, uint8_t channel, uint32_t period_us,
...
*/
void drv_pwm_config_clockdiv(pwm_handle_t handle, uint8_t channel,
                             uint32_t div);
...
*/
void drv_pwm_config_cb(pwm_handle_t handle, uint8_t channel,
                       pwm_event_cb_t cb_event);
...
*/
void drv_pwm_timer_set_timeout(pwm_handle_t handle, uint8_t channel,
                               uint32_t timeout);
...
*/
void drv_pwm_timer_get_current_value(pwm_handle_t handle, uint8_t channel,
                                     uint32_t *value);
...
*/
void drv_pwm_timer_get_load_value(pwm_handle_t handle, uint8_t channel,
                                  uint32_t *value);
...
*/
void drv_pwm_capture_config(pwm_handle_t handle, uint8_t channel,
